...
SITE_IDENTIFIER = 'master_filmes_online' #identifant (nom de votre fichier) remplacez les espaces et les . par _ AUCUN CARACTERE SPECIAL
SITE_NAME = 'Master_Filmes_Online' #nom que xbmc affiche
SITE_DESC = 'films en streaming, streaming hd, streaming 720p, Films/séries, récent' #description courte de votre source

URL_MAIN = 'http://masterfilmesonline.net/' #url de votre source
